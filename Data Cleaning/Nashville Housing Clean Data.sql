...
--since the soldasvacant is bit will add new column soldAsVacant


-- Step 1: Add a new column named SoldAsVacantText
ALTER TABLE NashvilleHousing
ADD SoldAsVacantText NVARCHAR(3);

-- Step 2: Update the values of SoldAsVacantText based on SoldAsVacant
UPDATE NashvilleHousing
...
--    'Excel 12.0; Database=Filepath', [Sheet1$]);
--GO
